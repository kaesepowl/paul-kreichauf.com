...
//
class PKTopicPrivacy extends LitElement {
	...
	render() {
		return html`
			...
			<p>
				...
				ein Recht, die Berichtigung, Sperrung oder L&ouml;schung dieser
				Daten zu verlangen. Hierzu sowie zu weiteren Fragen zum Thema
				Datenschutz k&ouml;nnen Sie sich jederzeit unter der im
			...
			<p>
				...
				Ihnen zur&uuml;ckverfolgt werden. Sie k&ouml;nnen dieser Analyse
			...
			<p>
				Sie k&ouml;nnen dieser Analyse widersprechen. &Uuml;ber die
				Widerspruchsm&ouml;glichkeiten werden wir Sie in dieser
				Datenschutzerkl&auml;rung informieren.
			</p>
			...
			<p>
				...
				Recht auf Berichtigung, Sperrung oder L&ouml;schung dieser
			...
			<p>
				...
				&ldquo;Session-Cookies&rdquo;. Sie werden nach Ende Ihres
			...
			<p>
				...
				erfolgt somit ausschlie&szlig;lich auf Grundlage Ihrer
				Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie k&ouml;nnen diese
				Einwilligung jederzeit widerrufen. Dazu reicht eine formlose
				Mitteilung per E-Mail an uns. Die Rechtm&auml;&szlig;igkeit der
				bis zum Widerruf erfolgten Datenverarbeitungsvorg&auml;nge
			...
			<p>
				...
				Cookies kann YouTube Informationen &uuml;ber Besucher unserer
			...
			<h3>Google Maps</h3>
			<p>
				Diese Seite nutzt &uuml;ber eine API den Kartendienst Google
				Maps. Anbieter ist die Google Inc., 1600 Amphitheatre Parkway,
			...
			<p>
				...
				besucht haben. Wenn Sie den &ldquo;Like-Button&rdquo; oder
				&ldquo;Share-Button&rdquo; anklicken w&auml;hrend Sie in Ihrem
				SoundCloud- Benutzerkonto eingeloggt sind, k&ouml;nnen Sie die
				Inhalte unserer Seiten mit Ihrem SoundCloud-Profil verlinken
				und/oder teilen. Dadurch kann SoundCloud Ihrem Benutzerkonto den
				Besuch unserer Seiten zuordnen. Wir weisen darauf hin, dass wir
				als Anbieter der Seiten keine Kenntnis vom Inhalt der
				&uuml;bermittelten Daten sowie deren Nutzung durch SoundCloud
				erhalten.
			</p>
			<p>
				Die Nutzung von SoundCloud erfolgt auf Grundlage des Art. 6 Abs.
			...
			<p>
				...
				Seiten Ihrem SoundCloud- Benutzerkonto zuordnet, loggen Sie sich
				bitte aus Ihrem SoundCloud-Benutzerkonto aus bevor Sie Inhalte
				des SoundCloud-Plugins aktivieren.
			</p>
...
//
window.customElements.define("pk-topic-privacy", PKTopicPrivacy);
